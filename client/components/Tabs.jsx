...
export default class Tabs extends Component {
    ...
    render() {
        let {tabs, current, onTabSwitch, onTabClose, onTabAdd, nativePrinter, listenToScanner, onScannerToggle} = this.props
        ...
        return <div className="tabs">
            ...
            <a className={["scanner", listenToScanner ? 'active' : 'inactive'].join(' ')} onTouchTap={onScannerToggle}>
