...
class Intro extends Step {
	getTitle() {
		return "Vítejte v Pokladně"
	}

	getDescription() {
		return "Než začneme pracovat, máme nějaký server?"
	}
	...
	getButtons() {
		...
		return [
			<div className="button" onClick={() => listener.introContinue(true)}>Spustit bez serveru</div>, 
			<div className="button" onClick={() => listener.introContinue(false)}>Najít běžící server</div>
		]
	}
}
