...
const Intro = () => <div className="step intro show">
	<h1>Vítejte v Pokladně!</h1>
	<h2>Než začneme pracovat, máme nějaký server?</h2>
	<div className="image">
	...
	<div className="buttons">
		<div className="button">Spustit bez serveru</div>
		<div className="button">Najít běžící server</div>
	</div>
</div>
